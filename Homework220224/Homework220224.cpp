...
public:
    ...
    void LastOrderLeakCheck(MapNode* Node)
    {
        if (nullptr != Node->LeftChild_)
        {
            LastOrderLeakCheck(Node->LeftChild_);
        }

        if (nullptr != Node->RightChild_)
        {
            LastOrderLeakCheck(Node->RightChild_);
        }
